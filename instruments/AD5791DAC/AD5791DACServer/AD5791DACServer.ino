...
IPAddress ip(10, 108, 30, 59);
IPAddress mydns(10, 108, 30, 1);
IPAddress gateway(10, 108, 30, 1);
...
AD5791 dac8 = AD5791(9);

AD5791 dacs[8] = {dac1, dac2, dac3, dac4, dac5, dac6, dac7,dac8};


int num_dacs = sizeof(dacs) / sizeof(AD5791);
